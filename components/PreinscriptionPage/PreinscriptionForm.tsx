...
export const PreinscriptionForm = ({ course }: CourseProp) => {
    ...
    const onSubmit: SubmitHandler<FormFields> = async (data: FormFields) => {
        const sanitizedData = Object.fromEntries(Object.entries(data).map(([key, value]) => [key, typeof value === 'string' ? value.trim() : value]));
        ...
        try {
            ...
            if (!result.success) throw new Error(result.error || "Error sending form.");
    ...
    return (
        <div className='col-span-2 mx-3 m-3 xl:m-1'>
                ...
                {submitMessage && (
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Botón */}
                            <Link className={`w-full py-2 px-4 rounded-md font-medium transition ${submitMessage.type === "success"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white p-6 rounded-md shadow-md text-gray-800">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                id='name'
                                type="text" name="name" required className="w-full border p-2 rounded-md" />
                            <AnimatePresence>
                                {errors.name && (
                                    <motion.div
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id='email' type="email" name="email" required className="w-full border p-2 rounded-md" />
                            <AnimatePresence>
                                {errors.email && (
                                    <motion.div
                                        initial={{ opacity: 0, y: -10 }}
                        ...
                        <div>
                            ...
                            <input
                                {...register("phone")}
                                id='phone'
                                type="tel" name="phone" className="w-full border p-2 rounded-md" />
                        </div>
                        <div>
                            ...
                            <input
                                {...register("country")}
                                id='country'
                                type="text" name="country" className="w-full border p-2 rounded-md" />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm required font-medium mb-1">Spanish level *</label>
                            <select
                                {...register("level", {
                                ...
                                id='level'
                                name="level" className="w-full border p-2 rounded-md">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id='nativeLanguage'
                                type="text" name="nativeLanguage" className="w-full border p-2 rounded-md" />
                            <AnimatePresence>
                        ...
                        <div>
                            <label className="block text-sm required font-medium mb-1">Availability *</label>
                            <select
                                ...
                                id='availability'
                                name="availability" className="w-full border p-2 rounded-md">
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        <div>
                            <label className="required block text-sm font-medium mb-1">How long have you studied Spanish? *</label>
                            <select
                                {...register("experience", {
                                ...
                                id='experience'
                                name="experience" className="w-full border p-2 rounded-md">
                        ...
                        <div>
                            <label className="required block text-sm font-medium mb-1">Have you studied Spanish in a classroom before? *</label>
                            <select
                                ...
                                id='previousCourses'
                                name="previousCourses" className="w-full border p-2 rounded-md">
                ...
                <div className="flex gap-2 text-sm text-gray-600 items-center">
                    <input
                        ...
                        id='privacy'
                        type="checkbox" name="privacy" required className="" />
                    <label>
