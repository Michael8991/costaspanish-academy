...
export const FilterBarCourses = ({ filters, setFilters }: FilterBarCoursesProps) => {
    ...
    const handleApplyFilters = () => {
        setFilters({
            ...
            modality: selectedModality as "Intensive" | "SemiIntensive" | "Standar" | "Private" | undefined,
            level: selectedLevel as "A1" | "A2" | "B1" | "B2" | "C1" | "C2" | undefined,
    ...
    return (
        <div className="flex align-middle justify-center mb-10 mt-4 gap-6 bg-white w-fit m-auto py-4 px-10 rounded-2xl shadow-md">
            <Dropdown
                id="language"
