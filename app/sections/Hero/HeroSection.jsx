...
export const HeroSection = () => {
    ...
    return (
        <div className={`container flex flex-col justify-center pb-5 md:pb-0 ${scrolled ? `${styles.headerspacerfixedbigscreen}` : ``}`} style={{
            minHeight: 'calc( 100vh - 120px )'
        }}>
            <div className={`${scrolled ? `${styles.headerspacerfixed}` : ``} header-spacer`}></div>
            <div className={` grid grid-cols-1 lg:grid-cols-2 mt-3 h-fit`}>
                <motion.div
                    ...
                    <h1 style={{}} className={`${styles.heroH1} text-center mb-0`}>
                        ...
                        <span className={`${styles.slidingVertical} justify-self-center`}>
                    ...
                    <span className={`text-center mb-3`}>Expert language training for adults, teens, and kids</span>
                    ...
                    <div className={`mb-5 sm:!mb-0 sm:grid grid-cols-1 md:grid-cols-2 md:flex items-center justify-center xl:w-fit mx-auto`}>
                        <div className="justify-center items-center grid-rows-1 w-full flex">
                            <a href='#courses' className={`${styles.callToActionBtn} text-base font-normal py-3 px-3.5 mb-3 sm:!mb-0`} style={{ textDecoration: 'none' }}>See our courses</a>
                        </div>
                        <div className="justify-center items-center grid-rows-1 md:ms-4 w-full flex">
                            <a className={`${styles.seeOurCoursesBtn} text-base font-normal gap-1 cursor-pointer`} >Start Learning Today!<ArrowIcon className="" /></a>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className='flex flex-col justify-end h-full' style={{ maxHeight: '400px' }}>
                    ...
                    >
                        ...
                        >
                            <img src={SpainFlag} alt="Spain Courses" className=' w-10 h-10 me-2 md:w-14 md:h-14 md:me-3' />
                            SPANISH
                        </motion.div>
                    </motion.div>
                    <motion.div
                        ...
                        <motion.div
                            ...
                            className={`${styles.floatingBoxShadow} hidden lg:flex z-2 relative w-fit h-16 md:h-18 py-1 px-3 bg-white rounded-2xl flex items-center justify-center font-extrabold text-base md:text-lg`}
                        >
                            <img src={UKFlag} alt="Spain Courses" className='w-10 h-10 me-2 md:w-14 md:h-14 md:me-3' />
                            ENGLISH
                        </motion.div>
                    </motion.div>
                    <Circle />
