...
export default function EnglishCoursesClient() {
    const [filters, setFilters] = useState<CourseFilters>({ language: "English" });
    ...
    return (
        <>
            ...
            <div className="flex items-center text-sm text-gray-500 mb-3 space-x-2 px-5">
                ...
                <Link href={`/${locale}/english`} className="hover:text-rose-400 transition-colors">
