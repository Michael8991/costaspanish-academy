...
export default function PreinscriptionClient({ locale, slug }: Props) {
    ...
    return (
        <div
            className={`max-w-7xl flex flex-col justify-center items-center mx-auto min-h-[calc(100vh-120px)]  ${scrolled ? styles.headerspacerfixedbigscreen : ""}`}
        >
            <div className={`${scrolled ? styles.headerspacerfixed : ""} header-spacer`} />
