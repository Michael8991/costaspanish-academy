...
export const mockCourses: ICourseData[] = [
    // Inglés Intensivo B1
    {
        ...
        price: '180€',
        hoursPerWeek: '8h',
        longDesc: 'Curso intensivo de inglés para nivel B1, diseñado para mejorar rápidamente comprensión, expresión oral y escrita.',
        maxPeople: '10',
        duration: '4 semanas',
        format: 'Online',
        level: 'B1',
        requirements: 'Nivel B1 certificado o experiencia previa',
        learningObjetives: 'Mejorar comprensión auditiva y expresión oral; ampliar vocabulario y gramática avanzada.',
        modules: 'Módulo 1: Gramática avanzada\nMódulo 2: Conversación práctica\nMódulo 3: Comprensión auditiva y lectura',
        technicalRequirements: 'Ordenador o tablet con cámara y micrófono; conexión a internet estable',
        modality: 'Grupo Intensivo',
    ...
    // Inglés Semi-intensivo B1
    {
        ...
        price: '120€',
        hoursPerWeek: '4h',
        longDesc: 'Curso semi-intensivo de inglés B1, ideal para reforzar el idioma mientras compaginas otras actividades.',
        maxPeople: '15',
        duration: '6 semanas',
        format: 'Online',
        level: 'B1',
        requirements: 'Nivel B1 certificado o experiencia previa',
        learningObjetives: 'Refuerzo de gramática y vocabulario, mejora de conversación y comprensión.',
        modules: 'Módulo 1: Gramática intermedia\nMódulo 2: Conversación guiada\nMódulo 3: Comprensión escrita y auditiva',
        technicalRequirements: 'Ordenador o tablet con cámara y micrófono; conexión a internet estable',
        modality: 'Grupo Semi-Intensivo',
    ...
    // Inglés Privado (nivel adaptado)
    {
        ...
        price: '220€',
        hoursPerWeek: '6h',
        longDesc: 'Curso privado de inglés, adaptado al nivel y objetivos del estudiante, con enfoque totalmente personalizado.',
        maxPeople: '1',
        format: 'Online',
        learningObjetives: 'Mejorar todas las competencias lingüísticas según necesidades personales.',
        modules: 'Módulos adaptados al estudiante',
        modality: 'Clases Privadas',
        access: 'Plataforma online propia',
        support: 'Tutor personal vía chat y email',
    ...
    // Español Intensivo B1
    {
        ...
        price: '180€',
        hoursPerWeek: '8h',
        longDesc: 'Curso intensivo de español B1, diseñado para consolidar habilidades de comunicación rápidamente.',
        maxPeople: '10',
        duration: '4 semanas',
        format: 'Online',
        level: 'B1',
    ...
    // Español Semi-intensivo B1
    {
        ...
        price: '120€',
        hoursPerWeek: '4h',
        longDesc: 'Curso semi-intensivo de español B1, ideal para reforzar tus competencias mientras realizas otras actividades.',
        maxPeople: '15',
        duration: '6 semanas',
        format: 'Online',
        level: 'B1',
    ...
    // Español Privado (nivel adaptado)
    {
        ...
        price: '220€',
        hoursPerWeek: '6h',
        longDesc: 'Curso privado de español adaptado al nivel y objetivos del estudiante.',
        maxPeople: '1',
        format: 'Online',
        learningObjetives: 'Mejorar todas las competencias lingüísticas según necesidades personales.',
        modules: 'Módulos adaptados al estudiante',
